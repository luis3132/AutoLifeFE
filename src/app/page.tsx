  ...
  return (
    <>
      <div className="px-4 py-6 lg:px-12">
        ...
        <div className="md:flex justify-between md:space-x-4 mb-12">
          ...
          <div className="bg-blue-200 rounded p-4 md:flex-1 text-center shadow-md">
          ...
          <div className="h-4 md:hidden"></div>
          <div className="bg-purple-200 rounded p-4 md:flex-1 text-center shadow-md">
